...
const PostCard = (props) => {
  ...
  <div className={styles.container}>
    ...
    <div className="border rounded p-10">
      ...
      <p>Contact : <span>{userToken ? <a className="text-red-500 font-bold hover:text-red-800" href={`mailto:${props.owner.email}`}>{props.owner.email}</a> : <span className="text-gray-600 italic">Connectez-vous pour voir les coordonnées du ou de la propriétaire !</span>}</span></p>
    </div>
  </div>
