...
const EditPost = ({post}) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`${process.env.url}/posts/${post.id}`, {
      method: "put",
      headers: {
  ...
  return (
    <div className={styles.container}>
      ...
      <div>
        ...
        <textarea name="content" ref={contentRef} defaultValue={post.content} required="required" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-5"/>
        <div>
